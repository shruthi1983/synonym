...
class SynonymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create synonym" do
    assert_difference('Synonym.count') do
      post synonyms_url, params: { synonym: { English_word: @synonym.English_word, Kannada_meaning: @synonym.Kannada_meaning } }
    end
  ...
  test "should update synonym" do
    patch synonym_url(@synonym), params: { synonym: { English_word: @synonym.English_word, Kannada_meaning: @synonym.Kannada_meaning } }
